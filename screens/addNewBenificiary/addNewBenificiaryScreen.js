  ...
  addBenificiaryButton() {
    return (
      <TouchableOpacity
        ...
        <Text style={{...Fonts.whiteColor16Bold}}>Add beneficiary</Text>
      </TouchableOpacity>
    );
  }
  ...
  accountDetail() {
    return (
      <View style={styles.accountDetailContentStyle}>
        <Text
          style={{...Fonts.blackColor16Bold, marginBottom: Sizes.fixPadding}}>
          Account Details
        </Text>
  ...
  bankDetail() {
    return (
      <View style={styles.bankDetailContentStyle}>
        <Text style={{...Fonts.blackColor16Bold}}>Bank Details</Text>
    ...
    return (
      <View>
        <SelectDropdown
          ...
          buttonTextStyle={{...Fonts.blackColor14Medium, textAlign: 'left'}}
          buttonStyle={styles.selectBankDropDownFieldStyle}
          renderDropdownIcon={() => (
            <MaterialIcons name="keyboard-arrow-down" size={24} color="black" />
          )}
          rowStyle={{
  ...
  header() {
    return (
      <View style={styles.headerContentStyle}>
        <Text style={{...Fonts.blackColor18Bold}}>Add new beneficiary</Text>
        <MaterialIcons
          name="arrow-back"
          size={24}
          color={Colors.blackColor}
