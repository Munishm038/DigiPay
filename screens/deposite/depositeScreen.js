...
import { Text, View, StyleSheet, SafeAreaView, StatusBar, BackHandler, FlatList, TouchableOpacity } from "react-native";
...
class DepositeScreen extends Component {
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <FlatList
                        ListHeaderComponent={
                            <>
                                {this.newDepositButton()}
                                {this.depositsTitle({ title: 'Pending Deposits' })}
                                {this.pendingDeposits()}
                                {this.depositsTitle({ title: 'Completed Deposits' })}
                            </>
                        }
    ...
    renderItem = ({ item }) => (
        <View style={{
            ...styles.depositsMainContentStyle, marginBottom: Sizes.fixPadding * 2.0,
        }}>
    ...
    pendingDeposits() {
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                marginBottom:
                    pendingDepositsList.length - 1 == index ? 0.0 :
    ...
    newDepositButton() {
        return (
            <TouchableOpacity
                activeOpacity={0.9}
                onPress={() => this.props.navigation.navigate('NewDeposit')}
                style={styles.newDepositButtonStyle}>
                <MaterialIcons name="add" size={20} color={Colors.whiteColor} />
                <Text style={{ ...Fonts.whiteColor16Bold, marginLeft: Sizes.fixPadding }}>
                    New deposit
                </Text>
            </TouchableOpacity>
        )
