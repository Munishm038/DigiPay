...
import { markers } from "../../component/nearByAtmsList";

const { width } = Dimensions.get('screen');

class NearByAtmsScreen extends Component {
    ...
    header() {
        return (
            <View style={styles.headerContentStyle}>
                <Text style={{ ...Fonts.blackColor18Bold }}>Nearby ATMs</Text>
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Animated.ScrollView
                ...
                style={styles.bankAtmsInfoContentStyle}
            ...
            >
                {markerList.map((marker, index) => (
                    <View key={index}>
                        <View style={styles.atmsInfoContentStyle}>
...
NearByAtmsScreen.navigationOptions = () => {
    return {
        header: () => null
    }
}
...
export default withNavigation(NearByAtmsScreen);